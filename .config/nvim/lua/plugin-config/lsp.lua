...
-- lspsaga scrolling
vim.cmd([[ nnoremap <silent> <C-f> :lua require('lspsaga.action').smart_scroll_with_saga(1)<cr> ]])
vim.cmd([[ nnoremap <silent> <C-b> :lua require('lspsaga.action').smart_scroll_with_saga(-1)<cr> ]])
